...
class ProyekModel extends Database {
    ...
    public function getLookup() {
        ...
        $query  = "SELECT id, name FROM proyek";
        try {
    ...
    public function getById($id) {
        ...
        $query  = "SELECT * FROM VwProyek WHERE id = :id;";
        try {
            $statement = $this->connection->prepare($query);
    ...
    public function insert($data) {
        ...
        try {
            ...
            $insertProyek = $this->insertProyek($data);
            if(!$insertProyek->success) {
                throw new Exception($insertProyek->message);
            }
     ...
     * 
     */
    public function insertPembayaran($proyekId, $data) {
        $result = (object)array(
            'success' => false,
            'message' => '',
            'rowAffected' => 0
